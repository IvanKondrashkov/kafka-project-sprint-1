...
public class PullConsumerFactory {
    ...
    private Properties consumerConfig() {
        ...
        properties.put(ConsumerConfig.GROUP_ID_CONFIG, config.getProperty("pull.consumer.group.id"));
        properties.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class.getName());
        properties.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, OrderDeserializer.class.getName());
        properties.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, config.getProperty("pull.consumer.auto.offset.reset"));
        properties.put(ConsumerConfig.ENABLE_AUTO_COMMIT_CONFIG, config.getProperty("pull.consumer.enable.auto.commit"));
        properties.put(ConsumerConfig.MAX_POLL_RECORDS_CONFIG, config.getProperty("pull.consumer.max.poll.records"));
        properties.put(ConsumerConfig.FETCH_MIN_BYTES_CONFIG, config.getProperty("pull.consumer.fetch.min.bytes"));
        return properties;
    }
